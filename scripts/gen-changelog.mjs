...
function readTrailerCommits() {
  ...
  for (const record of raw.split("\x1e")) {
    ...
    // 更新: is matched anywhere (subject or body) because the earliest
    // convention used single-line "更新: ..." subjects. 修复: only counts in
    // the body — otherwise every routine "修复: ..." subject (this repo's
    // commit style) would flood the public changelog. 更新 wins on conflicts.
