...
export const tradeReviews = pgTable("trade_reviews", {
  ...
  stopLossPrice: decimal("stoplossprice", { precision: 20, scale: 8 }),
  riskAmount: decimal("riskamount", { precision: 20, scale: 8 }),
  takeProfitTarget: decimal("takeprofittarget", { precision: 20, scale: 8 }),
  entryIntent: varchar("entryintent", { length: 32 }),
  entryTrigger: varchar("entrytrigger", { length: 32 }),
  entryTimeframe: varchar("entrytimeframe", { length: 8 }),
...
export const assistantWatchlist = pgTable("assistant_watchlist", {
  ...
  technicalState: varchar("technicalstate", { length: 32 }),
  observationPeriods: text("observationperiods"),
  keyCondition: text("keycondition"),
  note: text("note"),
