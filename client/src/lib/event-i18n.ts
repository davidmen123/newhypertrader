const KEYWORD_TRANSLATIONS: Record<string, string> = {
  ...
  "Housing Starts": "房屋开工",
  "Initial Jobless": "初请失业",
  "Continuing Jobless": "续请失业",
  "Non-Farm Payrolls": "非农就业人数",
  "Private Non-Farm": "私营部门非农",
  ...
  "5-Year Note": "5年期国债",
  "2-Year Note": "2年期国债",
  "3-Month Bill": "3个月期国库券",
  "6-Month Bill": "6个月期国库券",
  "FOMC Meeting": "FOMC会议",
  "Fed Interest": "美联储利率",
  "ISM Manufacturing": "ISM制造业",
  "ISM Services": "ISM服务业",
  "Retail Sales ex": "零售销售(除",
...
const FULL_TRANSLATIONS: Record<string, string> = {
  ...
  "Fed Chairman Warsh Testifies": "美联储主席Warsh作证",
