  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ color, fontSize: "1.02rem", lineHeight: 1.05 }}
      >
        {value}
      </div>
      {sub && (
        <div
          className="text-muted-foreground/55 mt-1"
...
function LeveragePanel({ ratio, lang }: { ratio: number; lang: string }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="mt-2 flex justify-between text-muted-foreground/45"
        style={{ fontSize: "0.58rem" }}
      >
        <span>0x</span>
        <span>5x</span>
...
function StatusPill({
  ...
  return (
    ...
    >
      <span
        className="text-muted-foreground/70 tracking-widest uppercase"
      ...
      <span
        ...
        style={{ color, fontSize: "0.68rem", letterSpacing: "0.08em" }}
      >
        {value}
      </span>
    </div>
...
export default function AccountOverview() {
  ...
  const { data, isLoading, isFetching, refetch } =
    trpc.hyperliquid.accountOverview.useQuery(undefined, {
    ...
    return (
      <div className="glass-card px-4 sm:px-8 py-5 sm:py-7 fade-in">
        <div className="text-muted-foreground text-sm animate-pulse">
          {t("加载账户概览...", "Loading account overview...")}
        </div>
      </div>
    );
  }
  ...
  const leverage = Number.isFinite(data.marginUsageRatio)
    ? data.marginUsageRatio
    : 0;
  ...
  return (
    <div className="glass-card px-4 sm:px-8 py-5 sm:py-7 fade-in">
      ...
      >
        ...
        />
        <span
          className="ml-auto text-muted-foreground/45 tracking-widest uppercase"
          style={{ fontSize: "0.58rem" }}
        >
          {t("30秒刷新", "30s refresh")}
        </span>
        ...
        <div className="space-y-2">
          ...
          <div className="grid gap-3 lg:grid-cols-[minmax(0,1.4fr)_minmax(220px,0.75fr)_minmax(260px,0.85fr)]">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, var(--surface-soft), var(--surface-subtle))",
                border: "1px solid var(--panel-border)",
            ...
            >
              ...
              <div
                className="num-display mt-3 text-foreground"
                style={{
              ...
              >
                ...
                <span
                  className="ml-2 text-muted-foreground/55"
              ...
              <div className="mt-3 flex flex-wrap items-center gap-3">
                <span
                  className="text-muted-foreground/65 num-display"
                  style={{ fontSize: "0.72rem" }}
                >
                  {isBtc
                    ? `≈ $${fmt(data.totalEquityUsdc, 2)} USDC`
                    : `≈ ${fmt(data.totalEquityBtc, 2)} BTC`}
                </span>
                <span
                ...
                >
                  {t("初始资金", "Initial")}{" "}
                  {data.initialEquityUsdc != null
                    ? `${fmt(data.initialEquityUsdc, 2)} USDC`
                    : "--"}
                </span>
              </div>
            </div>
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
            <MetricTile
              ...
              tone={
                data.maxDrawdownUsdc != null && data.maxDrawdownUsdc < 0
                  ? "loss"
                  : "neutral"
              }
            />
            <MetricTile
              ...
              value={
                data.sharpeRatio != null && isFinite(data.sharpeRatio)
                  ? fmt(data.sharpeRatio, 2)
                  : "--"
              }
              tone={
                data.sharpeRatio != null && data.sharpeRatio >= 1
                  ? "profit"
                  : "neutral"
              }
            />
            <MetricTile
              ...
              value={
                data.annualizedReturnPct != null
                  ? `${fmtSign(data.annualizedReturnPct, 2)}%`
                  : "--"
              }
              tone={
                data.annualizedReturnPct != null &&
                data.annualizedReturnPct >= 0
                  ? "profit"
                  : "loss"
              }
            />
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
            <MetricTile
              ...
              sub={
                metricsData?.totalTrades != null
                  ? `${metricsData.winningTrades}/${metricsData.totalTrades}`
                  : t("暂无交易", "No trades")
              }
            ...
            <MetricTile
              ...
              value={
                plRatio != null && isFinite(plRatio) ? fmt(plRatio, 2) : "--"
              }
            ...
            <MetricTile
              ...
              sub={
                metricsData
                  ? `${t("盈利", "Wins")} ${metricsData.winningTrades} · ${t("亏损", "Losses")} ${metricsData.losingTrades}`
                  : undefined
              }
              tone="neutral"
            />
