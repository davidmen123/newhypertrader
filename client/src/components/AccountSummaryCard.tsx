...
function StatItem({
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <span
        className={`num-display text-sm ${highlight ? "" : "text-foreground/90"}`}
      >
        {value}
      </span>
    </div>
...
export default function AccountSummaryCard() {
  ...
  return (
    <div className="glass-card px-8 py-7 fade-in">
      ...
      {isLoading && (
        <div className="text-muted-foreground text-sm num-display animate-pulse">
          Loading...
        </div>
      )}
      {error && <div className="text-loss text-sm">{error.message}</div>}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-5 mb-5">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="text-xl">
                  <PnlValue value={s.unrealized_pl} />
                </span>
              </div>
              <div className="flex flex-col gap-1">
                <span
