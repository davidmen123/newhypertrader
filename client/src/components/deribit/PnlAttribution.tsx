...
export default function PnlAttribution() {
  ...
  return (
    <div
      style={{
        background: "oklch(20% 0.025 200 / 50%)",
        border: "1px solid oklch(35% 0.02 200 / 30%)",
        borderRadius: 12,
        padding: "20px 24px",
      }}
    >
      ...
      {!isLoading && chartData.length > 0 && (
        <>
              ...
              {[
                ...
                return (
                  <div
                    key={key}
                    style={{
                      background: "oklch(18% 0.02 200 / 60%)",
                      border: "1px solid oklch(32% 0.02 200 / 30%)",
                      borderRadius: 8,
                      padding: "10px 12px",
                    }}
                  >
          ...
          <div style={{ height: 220 }}>
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                />
                <ReferenceLine y={0} stroke="oklch(40% 0.02 200 / 50%)" strokeWidth={1} />
          ...
          <div style={{ marginTop: 20 }}>
            ...
            >
              {lang === "zh" ? "最近快照 Greeks" : "Recent Snapshot Greeks"}
            </div>
                ...
                <thead>
                  <tr>
                    {[
                      ...
                      "Θ Theta",
                      "ν Vega",
                      lang === "zh" ? "BTC 价格" : "BTC Price",
                      lang === "zh" ? "总盈亏" : "Total P&L",
                    ].map((h) => (
                      <th
                        key={h}
                        style={{
                          ...
                          fontWeight: 400,
                          letterSpacing: "0.08em",
                          borderBottom: "1px solid oklch(32% 0.02 200 / 25%)",
                          whiteSpace: "nowrap",
                        }}
                      >
                        {h}
                    ...
                    <tr key={row.fullDate}>
                      <td
                        style={{
                          ...
                          borderBottom: "1px solid oklch(28% 0.02 200 / 15%)",
                          textAlign: "right",
                        }}
                      >
                        {row.fullDate}
                      ...
                      <td
                        style={{
                          padding: "5px 8px",
                          color: "oklch(60% 0.12 210)",
                          borderBottom: "1px solid oklch(28% 0.02 200 / 15%)",
                          textAlign: "right",
                        }}
                      >
                        {row.deltaTotal.toFixed(4)}
                      </td>
                      <td
                        style={{
                          padding: "5px 8px",
